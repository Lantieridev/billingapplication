    ...
    public class InvoiceService : IInvoiceService
    {
        ...
        public async Task<Invoice> CreateInvoiceAsync(Invoice invoice, List<InvoiceDetail> details)
        {
            try
            {
                ...
                invoice.InvoiceNumber = await _invoiceRepository.GenerateNextInvoiceNumberAsync();
                ...
                foreach (var detail in details)
                {
                    ...
                    await _invoiceRepository.UpdateStockAsync(detail.ProductId, detail.Quantity, "DECREMENT");
                }
