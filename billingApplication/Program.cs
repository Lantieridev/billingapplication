    ...
    public class BillingApp
    {
        ...
        private async Task CreateInvoiceAsync()
        {
            ...
            try
            {
                ...
                {
                    Console.WriteLine($"{product.Id}: {product.Name} - ${product.UnitPrice} - Stock: {product.Stock}");
                }
                ...
                Console.WriteLine($"Número: {createdInvoice.InvoiceNumber}");
        ...
        private async Task ListInvoicesAsync()
        {
            ...
            try
            {
                ...
                {
                    Console.WriteLine($"#{invoice.Id}: {invoice.InvoiceNumber} - {invoice.Date:dd/MM/yyyy} - ${invoice.Total}");
                }
            }
            catch (Exception ex)
            {
            ...
            if (int.TryParse(Console.ReadLine(), out int invoiceId))
            {
                ...
                try
                {
                    ...
                    if (invoice != null)
                    {
                        ...
                        Console.WriteLine($"📅 Fecha: {invoice.Date:dd/MM/yyyy}");
                        Console.WriteLine($"👤 Cliente: {invoice.Customer.Name}");
                        Console.WriteLine($"💳 Forma de Pago: {invoice.PaymentMethod.Name}");
                        Console.WriteLine($"💰 Total: ${invoice.Total}");

                        Console.WriteLine("\n🛒 Detalles:");
                        foreach (var detail in invoice.InvoiceDetails)
                        {
                            Console.WriteLine($"- {detail.Product.Name}: {detail.Quantity} x ${detail.UnitPrice} = ${detail.Subtotal}");
                        }
                    }
                    else
                    {
