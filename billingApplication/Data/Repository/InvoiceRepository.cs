...
namespace BillingApplication.Data.Repositories
{
    public class InvoiceRepository : IInvoiceRepository
    {
        ...
        public async Task<int> AddAsync(Invoice invoice)
        {
            ...
            parameters.Add("@NumeroFactura", invoice.InvoiceNumber);
            parameters.Add("@Fecha", invoice.Date);
            parameters.Add("@ClienteId", invoice.CustomerId);
            parameters.Add("@FormaPagoId", invoice.PaymentMethodId);
        ...
        public async Task<int> AddInvoiceDetailAsync(InvoiceDetail detail)
        {
            ...
            parameters.Add("@FacturaId", detail.InvoiceId);
            parameters.Add("@ArticuloId", detail.ProductId);
            parameters.Add("@Cantidad", detail.Quantity);
            parameters.Add("@PrecioUnitario", detail.UnitPrice);
